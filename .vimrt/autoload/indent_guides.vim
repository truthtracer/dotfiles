...
"  exe 'hi IndentGuidesOdd  guibg=' . l:gui_colors[1] . ' ctermbg=' . l:cterm_colors[1]
  ...
  let l:hi_normal_ctermbg = ''
  let l:hi_normal_ctermfg = ''
  let l:hi_Evn_bg = []
  let l:hi_Evn_fg = []
  let l:hi_Odd_bg = []
  let l:hi_Odd_fg = []
  ...
  if s:hi_normal =~ "ctermbg='\\?\\zs[0-9A-Za-z]\\+\\ze'\\?"
    let l:hi_normal_ctermbg = matchstr(s:hi_normal, "ctermbg='\\?\\zs[0-9A-Za-z]\\+\\ze'\\?")
    call add(l:hi_Evn_bg, float2nr(l:hi_normal_ctermbg + ((255 - l:hi_normal_ctermbg) * s:change_percent / 2)))
    call add(l:hi_Odd_bg, float2nr(l:hi_normal_ctermbg + ((255 - l:hi_normal_ctermbg) * s:change_percent)))
  endif

  " capture the foregroud color from the normal highlight
  if s:hi_normal =~ "ctermfg='\\?\\zs[0-9A-Za-z]\\+\\ze'\\?"
    let l:hi_normal_ctermfg = matchstr(s:hi_normal, "ctermfg='\\?\\zs[0-9A-Za-z]\\+\\ze'\\?")
    call add(l:hi_Evn_fg, float2nr(l:hi_normal_ctermfg + ((255 - l:hi_normal_ctermfg) * s:change_percent / 2)))
    call add(l:hi_Odd_fg, float2nr(l:hi_normal_ctermfg + ((255 - l:hi_normal_ctermfg) * s:change_percent)))
  endif

  exe 'hi IndentGuidesEven ctermfg=' . l:hi_Evn_fg[0] . ' ctermbg=' . l:hi_Evn_bg[0]
  exe 'hi IndentGuidesOdd  ctermfg=' . l:hi_Odd_fg[0] . ' ctermbg=' . l:hi_Odd_bg[0]
endfunction
