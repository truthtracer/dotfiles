...
let s:ex_exvim_lang_map['html'] = [ 'htm', 'html', 'css' ]
...
let s:ex_exvim_lang_map['php'] = [ 'php', 'class', 'inc', 'module' ]
...
let s:ex_ctags_lang_map['html'] = [ 'htm', 'html', 'css' ]
...
let s:ex_project_file_filter .= 'php,class,inc,module,js,css,'
