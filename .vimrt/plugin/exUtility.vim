...
if !exists ( "g:ex_default_langs" )
    let g:ex_default_langs = ['c', 'cpp', 'c#', 'java', 'javascript', 'shader', 'python', 'php', 'vim', 'uc', 'html', 'math', 'wiki', 'ini', 'make', 'sh', 'batch', 'debug' ] 
endif
...
if !exists ( "g:ex_cscope_langs" )
    let g:ex_cscope_langs = ['c', 'cpp', 'shader', 'asm', 'php', 'html', 'javascript'] 
endif
