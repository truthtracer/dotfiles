...
function s:exCS_ConnectCscopeFile() " <<<
...
function s:exCS_InitSelectWindow() " <<<
...
function s:exCS_UpdateSelectWindow() " <<<
...
function s:exCS_InitQuickViewWindow() " <<<
    silent! setlocal nonumber
...
function s:exCS_UpdateQuickViewWindow() " <<<
