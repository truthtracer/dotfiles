...
if test "${file_filter}" = ""; then
    file_filter="c|cpp|cxx|c\+\+|C|cc|h|H|hh|hxx|hpp|inl|cs|uc|hlsl|vsh|psh|fx|fxh|cg|shd|glsl|py|pyw|vim|awk|m|dox|doxygen|ini|cfg|wiki|mk|err|exe|bat|sh|php|inc|class|module|js|css"
fi
...
if test "${file_filter_pattern}" = ""; then
    file_filter_pattern="\\.c$|\\.C$|\\.cpp$|\\.cxx$|\\.c++$|\\.cc$|\\.h$|\\.H$|\\.hh$|\\.hxx$|\\.hpp$|\\.inl$|\\.cs$|\\.uc$|\\.hlsl$|\\.vsh$|\\.psh$|\\.fx$|\\.fxh$|\\.cg$|\\.shd$|\\.glsl$|\\.py$|\\.pyw$|\\.vim$|\\.awk$|\\.m$|\\.dox$|\\.doxygen$|\\.ini$|\\.cfg$|\\.wiki$|\\.mk$|\\.err$|\\.exe$|\\.bat$|\\.sh$|\\.txt$|\\.php$|\\.inc$|\\.class$|\\.module$|\\.js$|\\.css$"
fi
...
if test "${cscope_file_filter}" = ""; then
    cscope_file_filter="c|cpp|cxx|c\+\+|C|cc|h|H|hh|hxx|hpp|inl|hlsl|vsh|psh|fx|fxh|cg|shd|glsl|php|inc|class|module|js|css"
fi
...
if test "${cscope_file_filter_pattern}" = ""; then
    cscope_file_filter_pattern="\\.c$|\\.C$\\.cpp$|\\.cxx$|\\.c++$|\\.cc$|\\.h$|\\.H$|\\.hh$|\\.hxx$|\\.hpp$|\\.inl$|\\.hlsl$|\\.vsh$|\\.psh$|\\.fx$|\\.fxh$|\\.cg$|\\.shd$|\\.glsl$|\\.php$|\\.inc$|\\.class$|\\.module$|\\.js$|\\.css$"
fi
...
if test "${ctags_options}" = ""; then
    ctags_options="--c++-kinds=+p --fields=+iaS --extra=+q --languages=c,c++,c#,python,vim,html,lua,javascript,java,uc,math,php --langmap=c++:+.inl,c:+.fx,c:+.fxh,c:+.hlsl,c:+.vsh,c:+.psh,c:+.cg,c:+.shd,javascript:+.as"
fi
